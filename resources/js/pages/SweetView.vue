    ...
    <main class="main">
        ...
        <div class="section">
            ...
            <div v-else class="container">
                <template v-for="yogui in sweet" :key="yogui.id">
                    <div
                    ...
                    >
                        <div class="card_img">
                            <img :src="yogui.imgs[0]" alt="" />
                            <img :src="yogui.imgs[1]" alt="" />
                        </div>
        ...
        <div class="section">
            ...
            <Loader v-if="loading" />
            <div v-else class="container">
                <template v-for="creepe in sweet" :key="creepe.id">
                    <div
                    ...
                    >
                        <div class="card_img">
                            <img :src="creepe.imgs[0]" alt="" />
                            <img :src="creepe.imgs[1]" alt="" />
                        </div>
        ...
        <div class="section">
            ...
            <Loader v-if="loading" />
            <div v-else class="container">
                <template v-for="waffle in sweet" :key="waffle.id">
                    <div
                    ...
                    >
                        <div class="card_img">
                            <img :src="waffle.imgs[0]" alt="" />
                            <img :src="waffle.imgs[1]" alt="" />
                        </div>
